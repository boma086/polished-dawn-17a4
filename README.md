...
```
npm create cloudflare@latest -- --template=cloudflare/templates/polished-dawn-17a4
```

A live public deployment of this template is available at [https://polished-dawn-17a4.templates.workers.dev](https://polished-dawn-17a4.templates.workers.dev)
